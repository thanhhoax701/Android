...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button nut1 = this.findViewById(R.id.bt1);
        ...
        Button nut2 = this.findViewById(R.id.bt2);
        ...
        Button nut3 = this.findViewById(R.id.bt3);
        ...
        Button nut4 = this.findViewById(R.id.bt4);
        ...
        Button nut5 = this.findViewById(R.id.bt5);
